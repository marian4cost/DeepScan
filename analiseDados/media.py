...
# ============================================
# 1. Cálculo das médias das métricas por técnica
# ============================================
...
df_media = df.groupby("Tecnica")[["Contrast", "Homogeneity", "Energy", "Correlation"]].mean()

print("\nMÉDIA DAS MÉTRICAS POR TÉCNICA:")
print(df_media)

# ============================================
# 2. Gráfico das médias por técnica (linhas)
# ============================================

plt.figure(figsize=(12, 6))

for coluna in df_media.columns:
    plt.plot(df_media.index, df_media[coluna], marker='o', linewidth=2, label=coluna)

plt.title("Média das Métricas GLCM por Técnica (5 imagens)", fontsize=16)
